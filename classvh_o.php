...
<head>
    <meta charset="utf-8">
    <title>Admission - Ramakrishna Mission Vidyapith</title>
...
<body>
    ...
    <section>
        ...
        <div class="admi">
            <h1>STUDENTS LIST OF CLASS V & VI (SESSION - 2022)</h1>
        </div>
        <br><br>
    </section>
    ...
    <section class="container my-4">
        <center><h2>All Class V Students (Hostel & Outsider).</h2></center>
        <table class="table">
          <thead>
            <tr>
              <th scope="col">#</th>
          ...
          <tbody>
            <?php 
                $query = "SELECT * FROM candidates WHERE c_class = 'v' && h_l = '1'";
