...
<body>
    ...
    <section class="container my-4">
        <center><h2>All Class V Students (Local).</h2></center>
        <table class="table">
          <thead>
            <tr>
              <th scope="col">#</th>
          ...
          <tbody>
            <?php 
                $query = "SELECT * FROM classv WHERE h_l = '2'";
                ...
                while ( $row = mysqli_fetch_assoc($select_students) )
                {
                    ...
                    <tr>
                      ...
                      <td>
                        <div class="btn-group">
                            <a href="viewv.php?view_stu=<?php echo $form_id; ?>" class="btn btn-warning">View</a>
                        </div>
                      </td>
                    </tr>
